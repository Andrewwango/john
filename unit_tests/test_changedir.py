'''
Hardware test of GPS route-following unit.
For each GPX track point, manually turn the robot until facing towards next track point.
On running, "turn more" will be printed until the robot it facing towards the next track point,
and then move onto the next one, according to the GPX route.

Make sure this file is in same folder as gpxextractor and compassgpsutils!
'''

import time, math, pygame
import gpxextractor, compassgpsutils

XDEGREES=30 #amount to turn at pavement edge
